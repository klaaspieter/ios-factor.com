...
This way, you can configure your CI-system to automatically install and use a given Xcode version. You can also installed [chxcode] to automatically switch to Xcode versions.
